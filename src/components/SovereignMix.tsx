    ...
    return (
        <div className="bg-[#1e2b1a] border border-[#2c3928] rounded-2xl p-6 flex flex-col gap-4">
            <div className="flex justify-between items-start">
                <div>
                    <h3 className="text-white font-bold text-lg">Sovereign Mix</h3>
                    <p className="text-[#a3b99d] text-xs mt-1">Portfolio Allocation</p>
                </div>
                ...
                <div className="flex flex-col gap-3 w-full">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-white">G-Sec</span>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-white">SDLs</span>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-white">T-Bills</span>
                        </div>
            ...
            <div className="mt-2 bg-[#2c3928]/50 p-3 rounded-xl flex items-center gap-3">
                ...
                <p className="text-xs text-[#a3b99d]">100% Sovereign Backed. Your investments are secured by the Govt of India.</p>
            </div>
        </div>
    );
}
