                ...
                <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                    <div>
                        ...
                        <div className="relative group">
                            ...
                            <input className="w-full bg-[#142210] border border-[#2c3928] text-white text-sm rounded-xl focus:ring-1 focus:ring-primary focus:border-primary block pl-10 p-2.5 placeholder:text-gray-600 transition-all shadow-sm" id="name" placeholder="Rahul Kumar" type="text" />
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="relative group">
                            ...
                            <input className="w-full bg-[#142210] border border-[#2c3928] text-white text-sm rounded-xl focus:ring-1 focus:ring-primary focus:border-primary block pl-10 p-2.5 placeholder:text-gray-600 transition-all shadow-sm" id="email" placeholder="rahul@university.edu.in" type="email" />
                        </div>
                    </div>
                    <div>
                    ...
                    <div className="flex items-start mb-6">
                        <div className="flex items-center h-5">
                            <input className="w-4 h-4 border border-[#2c3928] rounded bg-[#142210] focus:ring-3 focus:ring-primary/20 focus:ring-offset-0 text-primary checked:bg-primary checked:border-primary" id="terms" type="checkbox" value="" />
                        </div>
